...
var foodlistLabel=label("foodlist","Choice of Foods :");
 var food1label=label("food1","South Korean");
 var food2label=label("food2","South Indian");
 var food3label=label("food3","Thailand");
 var food4label=label("food4","Japanese");
 var food5label=label("food5","Indonesia");
...
var food1name=food("input","checkbox","food","food1","South Korean","form-check-input" )
var food2name=food("input","checkbox","food","food2","South Indian","form-check-input" )
var food3name=food("input","checkbox","food","food3","Thailand","form-check-input" )
var food4name=food("input","checkbox","food","food4","Japanese","form-check-input" )
var food5name=food("input","checkbox","food","food5","Indonesia","form-check-input" )
